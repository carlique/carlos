## @file
#  CarlPkg platform DSC (minimal) to build our UEFI app.
##

[Defines]
  PLATFORM_NAME                  = CarlPkg
  PLATFORM_GUID                  = 2F0F7B39-9B7F-4C83-B7D0-9D6B4E60F7F7
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x0001001A
  OUTPUT_DIRECTORY               = Build/CarlPkg
